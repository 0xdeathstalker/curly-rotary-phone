...
export default function Hero() {
  return (
    <section className="flex flex-col lg:flex-row items-center justify-center gap-8 md:gap-20 py-28 md:py-32 px-5 md:px-16 bg-[linear-gradient(318deg,rgba(255,177,50,0.5)_10%,rgba(251,249,243,1)_60%,rgba(246,238,255,1)_100%)]">
      <div className="space-y-6">
        ...
        <div className="flex items-center gap-2 py-2 px-3 border rounded-xl bg-[#F9FAFB] max-w-[calc(100vw-40px)] md:max-w-2xl overflow-x-auto">
          <Image
          ...
          <div className="relative flex items-center gap-2 overflow-x-hidden">
            <div className="absolute top-0 left-0 w-5 h-full bg-linear-to-r from-[#F9FAFB] to-transparent" />
            ...
            <div className="absolute top-0 right-0 w-5 h-full bg-linear-to-l from-[#F9FAFB] to-transparent" />
          </div>
        </div>
        ...
        <div className="space-y-2 max-w-2xl">
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between">
            ...
            <ul>
              ...
              <li className="flex items-center gap-1">
                <CircleCheckBig className="size-[18px] text-[#58B09C]" />2
                Digital Signature
              </li>
              <li className="flex items-center gap-1">
                <CircleCheckBig className="size-[18px] text-[#58B09C]" />
